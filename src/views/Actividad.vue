      ...
      preguntas: [
        {
          id: 1,
          texto:
            'El público objetivo se define únicamente por la edad de los consumidores.',
          ...
          mensaje_correcto:
            'Excelente trabajo. Tiene un claro concepto del público objetivo.',
          mensaje_incorrecto:
        ...
        },
        {
          id: 2,
          texto:
            'Una correcta definición del público objetivo permite personalizar estrategias de contenido digital.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 3,
          texto:
            'Identificar los hábitos digitales de la audiencia no es necesario para determinar el público objetivo.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 4,
          texto:
            'El entorno familiar y social influye en la percepción del contenido digital por parte del público objetivo.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 5,
          texto:
            'El nivel educativo de un usuario nunca influye en su comportamiento digital.',
        ...
        },
        {
          id: 14,
          texto:
            'La segmentación consiste en dividir el mercado en grupos con características comunes.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 15,
          texto:
            'No es necesario verificar si los segmentos de mercado cumplen estándares como la medibilidad o accesibilidad.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 16,
          texto:
            'La segmentación psicográfica considera factores como valores, intereses y estilos de vida.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 17,
          texto:
            'Segmentar solamente por ubicación geográfica garantiza efectividad en la estrategia digital.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 18,
          texto:
            'Los criterios de segmentación son las variables específicas utilizadas para clasificar al público.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 19,
          texto:
            'Los estándares de segmentación se utilizan para validar si un grupo es útil o no.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 20,
          texto:
            'En la planeación de contenidos no es relevante si los segmentos son diferenciables.',
          imagen: require('@/assets/actividad/imagen4.png'),
          barajarRespuestas: true,
          opciones: [
            {
